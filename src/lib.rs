...
pub use demo::{demo_advisories, demo_repository};
pub use evidence::{
    EvidenceCatalog, EvidenceConfidence, EvidenceKind, EvidenceRecord, EvidenceSource,
    EvidenceSubject,
};
pub use export::{CycloneDxView, RemediationReport, VexView};
pub use lockfile::{
...
pub use platform::{
    GraphRecord, InMemoryGraphStore, ResolverJob, ResolverService, ResolverWorkQueue,
};
pub use query::{
