...
declarations, RPM runtime inventories, and CycloneDX SBOM component inventories.
The `graphscope evidence <path>` workflow auto-detects those formats and emits a
